...
#define LogError(frmt, ...)     LogObjc(DDLogLevelError,   (@"%@: " frmt), THIS_FILE, ##__VA_ARGS__)
#define LogWarn(frmt, ...)      LogObjc(DDLogLevelWarning,    (@"%@: " frmt), THIS_FILE, ##__VA_ARGS__)
#define LogInfo(frmt, ...)      LogObjc(DDLogLevelInfo,    (@"%@: " frmt), THIS_FILE, ##__VA_ARGS__)
#define LogVerbose(frmt, ...)   LogObjc(DDLogLevelVerbose, (@"%@: " frmt), THIS_FILE, ##__VA_ARGS__)

#define LogCError(frmt, ...)    LogC(DDLogLevelError,   (@"%@: " frmt), THIS_FILE, ##__VA_ARGS__)
#define LogCWarn(frmt, ...)     LogC(DDLogLevelWarning,    (@"%@: " frmt), THIS_FILE, ##__VA_ARGS__)
#define LogCInfo(frmt, ...)     LogC(DDLogLevelInfo,    (@"%@: " frmt), THIS_FILE, ##__VA_ARGS__)
#define LogCVerbose(frmt, ...)  LogC(DDLogLevelVerbose, (@"%@: " frmt), THIS_FILE, ##__VA_ARGS__)

#define LogTrace()              LogObjc(DDLogLevelVerbose, @"%@: %@", THIS_FILE, THIS_METHOD)
#define LogCTrace()             LogC(DDLogLevelVerbose, @"%@: %s", THIS_FILE, __FUNCTION__)
